...
## Configuration
Copy `Config.Sample.ps1` to `Config.ps1` and adjust values as required. The sample file lists all supported BIOS field keys, their default values and the allowed formats for each field.
